...
<div class="card">
                                            <div class="card-header">
                                                <h5>Manage all users in the system</h5>
                                                <div class="alert alert-primary icons-alert" style="margin-top: 1%">
                                                                   
                                                                    <p><strong>This interface gives you access to user management.
                                            ...
                                            @foreach($Users as $User)
                                                                <tr>
                                                                    ...
                                                                    <td>{{$User->email}}</td>
                                                                  <td><a data-route="{{ route('DeleteUser', ['id'=>$User->id]) }}" class=" btn DeleteUser btn-sm btn-danger"  style="color:white">Delete Student</a></td>
